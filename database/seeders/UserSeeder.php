    ...
    public function run(): void
    {
        $users = [
            ...
            [
                ...
                'username' => 'up3.langsa',
                'email' => 'manager.up3langsa@pln.co.id',
            ...
            [
                ...
                'email' => 'supervisor.ulplangsakt@pln.co.id',
            ...
            [
                ...
                'email' => 'supervisor.ulpkualasimpang@pln.co.id',
                'password' => Hash::make('ulp123'),
                'role' => 'user',
                'unit_id' => 'ulp_ksp',
                'nip' => 'ULP002',
            ...
            [
                ...
                'email' => 'supervisor.ulppeureulak@pln.co.id',
                'password' => Hash::make('ulp123'),
                'role' => 'user',
                'unit_id' => 'ulp_plk',
                'nip' => 'ULP003',
            ...
            [
                ...
                'username' => 'ulp.idi',
                'email' => 'supervisor.ulpidi@pln.co.id',
                'password' => Hash::make('ulp123'),
                'role' => 'user',
                'unit_id' => 'ulp_idi',
                'nip' => 'ULP004',
